...
countries = os.listdir('Pictures/Country/')
made = []
for country in countries:
	base 		= 'Pictures/Country/' + country + '/'
	if(country not in made):
		made.append(country)
		os.mkdir('Worked/Country/' + country)
	...
	for image in images:
		...
		for k, d in enumerate(dets):
			...
			cv2.imwrite("Worked/Country/" + country + '/' + image, dst)